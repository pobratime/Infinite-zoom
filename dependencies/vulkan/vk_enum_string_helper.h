...
static inline const char* string_VkStructureType(VkStructureType input_value) {
    switch (input_value) {
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_STENCIL_RESOinfvlk_PROPERTIES:
            return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_STENCIL_RESOinfvlk_PROPERTIES";
        case VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOinfvlk:
            return "VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOinfvlk";
        ...
        case VK_STRUCTURE_TYPE_RESOinfvlk_IMAGE_INFO_2:
            return "VK_STRUCTURE_TYPE_RESOinfvlk_IMAGE_INFO_2";
        ...
        case VK_STRUCTURE_TYPE_IMAGE_RESOinfvlk_2:
            return "VK_STRUCTURE_TYPE_IMAGE_RESOinfvlk_2";
        ...
        case VK_STRUCTURE_TYPE_SUBPASS_RESOinfvlk_PERFORMANCE_QUERY_EXT:
            return "VK_STRUCTURE_TYPE_SUBPASS_RESOinfvlk_PERFORMANCE_QUERY_EXT";
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_SET_HOST_MAPPING_FEATURES_VAinfvlk:
            return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_SET_HOST_MAPPING_FEATURES_VAinfvlk";
        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_BINDING_REFERENCE_VAinfvlk:
            return "VK_STRUCTURE_TYPE_DESCRIPTOR_SET_BINDING_REFERENCE_VAinfvlk";
        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_HOST_MAPPING_INFO_VAinfvlk:
            return "VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_HOST_MAPPING_INFO_VAinfvlk";
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_FORMAT_RESOinfvlk_FEATURES_ANDROID:
            return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_FORMAT_RESOinfvlk_FEATURES_ANDROID";
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_FORMAT_RESOinfvlk_PROPERTIES_ANDROID:
            return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_FORMAT_RESOinfvlk_PROPERTIES_ANDROID";
        case VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_FORMAT_RESOinfvlk_PROPERTIES_ANDROID:
            return "VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_FORMAT_RESOinfvlk_PROPERTIES_ANDROID";
...
static inline const char* string_VkSubpassMergeStatusEXT(VkSubpassMergeStatusEXT input_value) {
    switch (input_value) {
        ...
        case VK_SUBPASS_MERGE_STATUS_NOT_MERGED_RESOinfvlk_ATTACHMENT_REUSE_EXT:
            return "VK_SUBPASS_MERGE_STATUS_NOT_MERGED_RESOinfvlk_ATTACHMENT_REUSE_EXT";
...
static inline const char* string_VkSubpassDescriptionFlagBits(VkSubpassDescriptionFlagBits input_value) {
    switch (input_value) {
        ...
        case VK_SUBPASS_DESCRIPTION_SHADER_RESOinfvlk_BIT_QCOM:
            return "VK_SUBPASS_DESCRIPTION_SHADER_RESOinfvlk_BIT_QCOM";
...
#endif // __cplusplus
static inline const char* string_VkResoinfvlkModeFlagBits(VkResoinfvlkModeFlagBits input_value) {
    switch (input_value) {
        case VK_RESOinfvlk_MODE_NONE:
            return "VK_RESOinfvlk_MODE_NONE";
        case VK_RESOinfvlk_MODE_SAMPLE_ZERO_BIT:
            return "VK_RESOinfvlk_MODE_SAMPLE_ZERO_BIT";
        case VK_RESOinfvlk_MODE_AVERAGE_BIT:
            return "VK_RESOinfvlk_MODE_AVERAGE_BIT";
        case VK_RESOinfvlk_MODE_MIN_BIT:
            return "VK_RESOinfvlk_MODE_MIN_BIT";
        case VK_RESOinfvlk_MODE_MAX_BIT:
            return "VK_RESOinfvlk_MODE_MAX_BIT";
        case VK_RESOinfvlk_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_ANDROID:
            return "VK_RESOinfvlk_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_ANDROID";
        default:
            return "Unhandled VkResoinfvlkModeFlagBits";
    }
}

#ifdef __cplusplus
static inline std::string string_VkResoinfvlkModeFlags(VkResoinfvlkModeFlags input_value) {
    std::string ret;
    int index = 0;
    while(input_value) {
        if (input_value & 1) {
            if( !ret.empty()) ret.append("|");
            ret.append(string_VkResoinfvlkModeFlagBits(static_cast<VkResoinfvlkModeFlagBits>(1U << index)));
        }
        ++index;
        input_value >>= 1;
    }
    if (ret.empty()) ret.append("VkResoinfvlkModeFlags(0)");
    return ret;
}
#endif // __cplusplus
...
static inline const char* string_VkPipelineStageFlagBits2(uint64_t input_value) {
    ...
    if (input_value == VK_PIPELINE_STAGE_2_RESOinfvlk_BIT) return "VK_PIPELINE_STAGE_2_RESOinfvlk_BIT";
